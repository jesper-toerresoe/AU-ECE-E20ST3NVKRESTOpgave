...
namespace HL7FHIRClient
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //In this template we are using a 1:Many association between the BMPCompleteSequence and the BMPLocalSampleSequence
            //Here each step simualed covers 1 second with 50 sample values 
            using (var localdbcache = new LocalCacheDBContext())
            {
                ...
                for (var step = 0; step < 100; step++) //Simulation 1 hour in steps of second
                {                    
                ...
                //But first retrieve complete sequence from local cache
